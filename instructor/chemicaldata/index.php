            ...
            <div class="card material-table">
                ...
                <div id="datatable_wrapper" class="dataTables_wrapper no-footer">
                    ...
                    <table id="datatable" class="dataTable no-footer" role="grid" aria-describedby="datatable_info">
                        <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Name</th>
